...
export default function MobileBar() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'white', borderTop: '1px solid #e8f0e8', boxShadow: '0 -4px 20px rgba(0,0,0,0.08)' }}
    >
      <div className="grid grid-cols-2 h-16">
        <a
          href="tel:+905403363873"
          className="flex items-center justify-center gap-2 font-bold text-sm transition-all active:opacity-80"
          style={{ backgroundColor: '#404e5e', color: 'white' }}
